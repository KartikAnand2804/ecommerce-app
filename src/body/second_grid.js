...
export default function SecondGrid(){
    return(
        ...
        <img
         className="d-block" style={{width:'50vw'}}
        ...
        <div className ="secondgrid"style={{ margin: '0 auto',width: '50vw'}}>
            ...
            <img alt="timer" style={{display: 'inline-block',width: '25vw'}} src="https://oasis.opstatics.com/content/dam/oasis/page/homepage/new-in/tile/watch-l.jpg"/>
            </div>
            
            
            <div className="container5" style={{display: 'inline-block',width: '25vw'}}>
            <img alt="timer" style={{display: 'inline-block',width: '25vw'}} src="https://oasis.opstatics.com/content/dam/oasis/page/homepage/new-in/tile/BWZ2-Red-L.jpg"/>
